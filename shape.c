...
void createShapeVector(){
	...
	shpmat[2][0] = 0x03; shpmat[2][1] = 0x03; shpmat[2][2] = 0x00; shpmat[2][3] = 0x00;
	shpmat[3][0] = 0x06; shpmat[3][1] = 0x03; shpmat[3][2] = 0x00; shpmat[3][3] = 0x00;
...
Shape* shapeMatrixRotate(Shape* shp){
	int i,j;
	uint8_t helpNo = 0;
	Shape* newShape = shapeInit(shp->shpMat);
